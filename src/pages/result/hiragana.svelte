<div
  ...
  <h1
    class="text-6xl px-4 py-2 bg-green-900 text-white font-bold mt-16 mb-8
      tracking-widest rounded-md mplus">
    Final
    <span class="text-green-900 bg-gray-100 rounded-md px-2">Result</span>
  </h1>
  <div
    class="flex justify-between items-center w-full p-4 bg-white rounded-md
      shadow-md">
    <span class="text-2xl mplus">Your average time was
      <span class="font-bold">{average}
        second.
        <span
    ...
    <Button
      ...
      href="/"
      txt="Play Again"
      styles="bg-green-900 text-white mplus px-4 py-2 self-start hover:bg-black hover:move-up" />
  </div>
  <div
    ...
    <div class="w-full grid gap-8 mt-4">
...
<script>
  ...
  import Table from "./_components/TableHiragana.svelte"
  import Button from "../_components/Button.svelte"
  import { metatags } from "@sveltech/routify"

  metatags.title = "Hiragana Result | カナイズ"
